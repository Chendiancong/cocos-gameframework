...
declare module 'fairygui-cc' {
    ...
    export { defaultParser } from "fairygui-cc/utils/UBBParser";
    export { ByteBuffer } from "fairygui-cc/utils/ByteBuffer";
    export { ArrayCollection } from "fairygui-cc/utils/ArrayCollection";
    export { MyEvent } from "fairygui-cc/event/MyEvent";
    export { JobSystem, IJob, jobSystem } from "fairygui-cc/utils/JobSystem";
    export * from "fairygui-cc/utils/ListPageManager";
    export * from "fairygui-cc/UserData";
}
...
declare module 'fairygui-cc/GObject' {
    ...
    import { ByteBuffer } from "fairygui-cc/utils/ByteBuffer";
    export const enum GObjectStates {
        Init = 0,
        AfterConstruct = 1,
        FirstTimeVisible = 2,
        ReadyForFirstTimeVisible = 1
    }
    export class GObject {
        ...
        protected _isFirstTimeEnabled: boolean;
        protected _objectStates: GObjectStates;
        ...
        protected _ccRender: any;
        protected _extraRenderers: any[];
        ...
        get guide_key(): string;
        set guide_key(value: string);
        get x(): number;
        set x(value: number);
        get y(): number;
        set y(value: number);
        get dragPosition(): Vec2;
        ...
        get isFirstTimeVisible(): boolean;
        setSize(wv: number, hv: number, ignorePivot?: boolean): void;
        makeFullScreen(): void;
        makeFullContainer(target: GObject): void;
        ensureSizeCorrect(): void;
        ...
        setAlphaNotupdateGear(value: number): void;
        get visible(): boolean;
        ...
        protected firstTimeVisible(): void;
        protected onFirstTimeVisible(): void;
        onConstruct(): void;
        ...
        set data(val: any);
        get data(): any;
        beforeConstructEntry(): void;
        constructFromResource(): void;
        setup_beforeAdd(buffer: ByteBuffer, beginPos: number): void;
        setup_afterAdd(buffer: ByteBuffer, beginPos: number): void;
        getGear(index: number): GearBase;
        selfSetUpGear(target: GObject, index: number, ctr: Controller, values: string): void;
        protected setObjectData(val: any): void;
        emitViewChange(): void;
        protected setCCRenderer(renderer: {
            new (): Component;
        }): void;
    }
    ...
    export let closeTask: (id: number, force: boolean) => void;
    export let addTask: (id: number, fn: (task: {
        done(): void;
    }) => void, ontimeout?: () => void, timeoutMs?: number) => boolean;
}
...
declare module 'fairygui-cc/GRoot' {
    import { Vec2, AudioClip, AudioSourceComponent, Node, Rect } from "cc";
    ...
    export class GRoot extends GComponent {
        ...
        static create(rootParent: Node): GRoot;
        constructor();
        protected onDestroy(): void;
        ...
        get oneShotAudioEngine(): AudioSourceComponent;
        get audioEngine(): AudioSourceComponent;
        onWinResize(): void;
        handlePositionChanged(): void;
    }
}
...
declare module 'fairygui-cc/GTextField' {
    import { Color, Component, Font, HorizontalTextAlignment, Label, Vec2, VerticalTextAlignment } from "cc";
    ...
    export class GTextField extends GObject {
        ...
        ensureSizeCorrect(): void;
        textCountDown<T extends Component>(option: {
            /** 提供定时服务的宿主组件 */
            scheduler: T;
            /** 获取倒计时（秒） */
            getLeftSec: () => number;
            /** 转换器，将剩余时间转换为特定文本 */
            translateFunc?: (timeValue: number) => string;
            /** 模板的key值 */
            templateKey?: string;
            /** 结束时的显示文本 */
            endMsg?: string;
...
declare module 'fairygui-cc/GRichTextField' {
    import { Color, HorizontalTextAlignment, RichText, SpriteAtlas, SpriteFrame, Vec2, VerticalTextAlignment } from "cc";
...
declare module 'fairygui-cc/GLoader' {
    import { Color, Component, Node, Prefab, SpriteFrame, Vec2 } from "cc";
    import { MovieClip } from "fairygui-cc/display/MovieClip";
    import { AlignType, VertAlignType, LoaderFillType, FillMethod, FillOrigin, PackageItemType } from "fairygui-cc/FieldTypes";
    import { GComponent } from "fairygui-cc/GComponent";
    import { GObject } from "fairygui-cc/GObject";
    import { ByteBuffer } from "fairygui-cc/utils/ByteBuffer";
    export class GLoader extends GObject {
        _content: MovieClip;
        _contentType: PackageItemType;
        loaded: boolean;
        constructor();
        protected onEnable(): void;
        protected onFirstTimeVisible(): void;
        ...
        setAsyncUrl(callUrl: Promise<string> | string): void;
        setPrefabLoadedFun(func: Function): void;
        get icon(): string | null;
        set icon(value: string | null);
        get align(): AlignType;
        ...
        get componentTouch(): boolean;
        set componentTouch(val: boolean);
        get componentRender(): boolean;
        set componentRender(val: boolean);
        get externalNode(): Node;
        ...
        get ccRender(): any;
        addContentRenderer(val: {
            new (): Component;
        }, params?: {
            [x: string]: any;
        }): any;
        removeContentRenderers(): void;
        /** 设置触摸穿透(加载好component后设置) */
        setTouchPenetrate(): void;
        play(times?: number): void;
        protected _onComplete: (obj: GObject) => void;
        stop(): void;
        protected loadFromPackage(itemURL?: string): void;
        protected _loadFromPackage(itemURL?: string): void;
        get isInitContent(): boolean;
        protected loadExternal(): void;
        protected freeExternal(texture: SpriteFrame): void;
        protected onExternalLoadSuccess(texture: SpriteFrame): void;
        protected onExternalSpriteLoadSuccess(texture: SpriteFrame): void;
        protected onExternalPrefabLoadSuccess(prefab: Prefab): void;
...
declare module 'fairygui-cc/GComponent' {
    import { Mask, Vec2, Node, Constructor, Component } from "cc";
    import { Controller } from "fairygui-cc/Controller";
    ...
    export class GComponent extends GObject {
        ...
        on(type: string, listener: Function, target?: any): void;
        once(type: string, listener: Function, target?: any): void;
        getChildByNames(arr: string[]): GObject;
        ...
        protected onDisable(): void;
        protected onFirstTimeVisible(): void;
        set observerModleEnable(fun: Function);
        set observerModleDisable(fun: Function);
    }
}
...
declare module 'fairygui-cc/GButton' {
    ...
    export class GButton extends GComponent {
        ...
        protected constructExtension(buffer: ByteBuffer): void;
        setup_afterAdd(buffer: ByteBuffer, beginPos: number): void;
        soundSilence(v: boolean): void;
        set thouchCheck(checkFun: () => boolean);
    }
}
...
declare module 'fairygui-cc/GComboBox' {
    ...
    export class GComboBox extends GComponent {
        ...
        getProp(index: number): any;
        setProp(index: number, value: any): void;
        autoShowOrHideDropdown(values: any[]): void;
        protected constructExtension(buffer: ByteBuffer): void;
        handleControllerChanged(c: Controller): void;
        dispose(): void;
        setup_afterAdd(buffer: ByteBuffer, beginPos: number): void;
...
declare module 'fairygui-cc/GProgressBar' {
    ...
    export class GProgressBar extends GComponent {
        ...
        tweenLevelValue(value: number, maxValue: number, level: number, duration: number): GTweener;
        reset(value?: number, maxValue?: number, level?: number): void;
...
declare module 'fairygui-cc/GList' {
    import { Size, Vec2, Component } from "cc";
    import { Controller } from "fairygui-cc/Controller";
    import { MyEvent } from "fairygui-cc/event/MyEvent";
    ...
    import { ArrayCollection } from "fairygui-cc/utils/ArrayCollection";
    import { ByteBuffer } from "fairygui-cc/utils/ByteBuffer";
    import { ListPageManager } from "fairygui-cc/utils/ListPageManager";
    export type ListItemRenderer = (index: number, item: GObject) => void;
    export class GList<T = any> extends GComponent {
            ...
            set ccItemRenderer(val: new () => Component);
            get ccItemRenderer(): new () => Component;
            ...
            get selectionController(): Controller;
            set selectionController(value: Controller);
            get isItemAsync(): boolean;
            get pageManager(): ListPageManager;
            onItemClick(listener: (item: GObject, evt: MyEvent) => void, target?: any): void;
            onItemSelect(listener: (item: GObject, evt: MyEvent) => void, target?: any): void;
            get itemPool(): GObjectPool;
            /**
                * 设置GList的对象池，需要在setData之前进行设置
                */
            set itemPool(value: GObjectPool);
            get poolDetached(): boolean;
            /**
                * 是否分离对象池，分离的对象池在GList.dispose的时候不会清理元素
                */
            set poolDetached(value: boolean);
            getFromPool(url?: string): GObject;
            returnToPool(obj: GObject): void;
            addChildAt(child: GObject, index: number): GObject;
            addItem(url?: string): GObject;
            addItemFromPool(url?: string): GObject;
            addItemFromPoolAt(index: number, url?: string): GObject;
            removeChildAt(index: number, dispose?: boolean): GObject;
            ...
            protected dispatchSelectEvent(item: GObject, evt: MyEvent): void;
            protected dispatchItemEvent(item: GObject, evt: MyEvent): void;
            dispatchSelected(): void;
            /**
                * 使用 setListDataAndResizeToFit 替换
                * @deprecated
                */
            resizeToFit(itemCount?: number, minSize?: number, maxSize?: number): void;
            /**
                * 设置尺寸
                ...
                * @param offSize 偏移值
                */
            preSetSizeToFit(itemCount: number, offSize?: number): void;
            getMaxItemWidth(): number;
            get selectedItemData(): T;
            get selectedItemDatas(): T[];
            protected handleSizeChanged(): void;
            handleControllerChanged(c: Controller): void;
            getSnappingPosition(xValue: number, yValue: number, resultPoint?: Vec2): Vec2;
            ...
            get listData(): T[];
            set listData(val: T[]);
            setListData(val: T[]): Promise<ArrayCollection<T>>;
            setListDataImmediately(val: T[]): ArrayCollection<T>;
            /**
                ...
                */
            setListDataAndResizeToFit(val: T[], minSize?: number, maxSize?: number, offSize?: number): Promise<void>;
            playChidTransitions(gapSec: number, transName?: string): void;
            /**
                * 设置list数据，并且 ResizeToFit
                * @param val 列表值
                * @param minSize 根据列表类型 宽或高的最小尺寸
                * @param maxSize 根据列表类型 宽或高的最大尺寸
                */
            setListDataAndResizeToFitImmediately(val: T[], minSize?: number, maxSize?: number, offSize?: number): void;
            getOrSetDataProvider(): ArrayCollection<T>;
            getDataProvider(): ArrayCollection<T>;
            setDataProvider(val: ArrayCollection<T>): void;
            refreshList(): void;
            itemAddedHandler(item: T, index: number): void;
            itemAddedMultHandler(items: T[], index: number, scrollBottom: boolean): void;
            itemRemovedHandler(items: T[], index: number): void;
            itemUpdatedHandler(item: T, index: number): void;
    }
}
...
declare module 'fairygui-cc/GTreeNode' {
    ...
    export class GTreeNode {
        ...
        _cell: GComponent;
        _resURL?: string;
        constructor(hasChild?: boolean, resURL?: string, render?: new () => Component);
        set ccItemRenderer(val: new () => Component);
        set data(v: any);
        get data(): any;
...
declare module 'fairygui-cc/Controller' {
    ...
    export class Controller extends EventTarget {
        ...
        set setupFlag(v: boolean);
        get setupFlag(): boolean;
...
declare module 'fairygui-cc/Transition' {
    ...
    export class Transition {
        ...
        set startHook(hook: (obj: GComponent) => void);
...
declare module 'fairygui-cc/ScrollPane' {
    ...
    export class ScrollPane extends Component {
        ...
        setMoveCaptureTouchFlag(flag: boolean): void;
...
declare module 'fairygui-cc/FieldTypes' {
    ...
    export enum UIPackageLoadingMode {
        /** 默认（同步加载） */
        Normal = 0,
        /** 异步加载 */
        Async = 1,
...
declare module 'fairygui-cc/UIPackage' {
    import { AssetManager, Rect, Size, Vec2 } from "cc";
    import { UIPackageLoadingMode } from "fairygui-cc/FieldTypes";
    import { GObject } from "fairygui-cc/GObject";
    import { PackageItem } from "fairygui-cc/PackageItem";
    ...
    export class UIPackage {
            _branchIndex: number;
            get isValid(): boolean;
            get loadingMode(): UIPackageLoadingMode;
            get bundle(): AssetManager.Bundle;
            get sprites(): {
                    [index: string]: AtlasSprite;
            };
            constructor();
            ...
            static tryLoadAloneImagePackage(path: string): Promise<string[]>;
            /**
                * 预加载一个包以及包中的资源，
                * 加载的过程是异步的。
                */
            static preloadPackage(path: string, bundle?: AssetManager.Bundle): Promise<UIPackage>;
            static removePackage(packageIdOrName: string): void;
            static removeAllPackage(): void;
            static createObject(pkgName: string, resName: string, userClass?: new () => GObject, useJobIfComponent?: boolean): GObject;
            static createObjectFromURL(url: string, userClass?: new () => GObject, useJobIfComponent?: boolean): GObject;
            ...
            /** 通过包名获取package的加载模式 */
            static convertLoadingMode(pkgName: string): UIPackageLoadingMode;
            dispose(): void;
            addRef(): this;
            decRef(): this;
            addDependencyName(pkgName: string): void;
            get refCount(): number;
            get id(): string;
            get name(): string;
            get path(): string;
            get dependencies(): Array<PackageDependency>;
            createObject(resName: string, userClass?: new () => GObject, useJobIfComponent?: boolean): GObject;
            internalCreateObject(item: PackageItem, userClass?: new () => GObject, useJobIfComponent?: boolean): GObject;
            getItemById(itemId: string): PackageItem;
            getItemByName(resName: string): PackageItem;
            getItemAssetByName(resName: string, onLoad: (err: Error, item: PackageItem) => void): void;
            getItemAsset(item: PackageItem, onLoad: (err: Error, item: PackageItem) => void): void;
            /**
                * @deprecated
                */
            loadAllAssets(onLoad: (err: Error, items: PackageItem[]) => void): void;
            /**
                * @ 特殊需要先加载图片资源的情况使用
                */
            initLoadImagesAssets(): void;
            addLoadedHandler(handler: (pkg: UIPackage) => void): void;
    }
...
declare module 'fairygui-cc/PackageItem' {
    ...
    import { PackageItemType, ObjectType, PackageItemState } from "fairygui-cc/FieldTypes";
    ...
    export class PackageItem {
            ...
            /**
                * 获取资源，如果没有加载则自动加载
                */
            getAsset(onLoad: (err: Error, item: PackageItem) => void): void;
            /**
                * 立即获取资源，资源没有加载的话会自动加载，但不会等待资源加载成功
                */
            getAssetImmediately<T extends Asset>(): T;
            getBranch(): PackageItem;
            getHighResolution(): PackageItem;
            toString(): string;
            loadAsset(onComplete?: (err: Error, item: PackageItem) => void): void;
            aloadAsset(): Promise<PackageItem>;
    }
}
...
declare module 'fairygui-cc/GObjectPool' {
    ...
    export class GObjectPool {
        ...
        clear(): void;
        get count(): number;
        getObject(url: string, useJobIfComponent?: boolean): GObject;
...
declare module 'fairygui-cc/UIConfig' {
    ...
    import { PackageLoadType } from "fairygui-cc/FieldTypes";
    import { ArrayCollection, GList } from "fairygui-cc/FairyGUI";
    export class UIConfig {
        constructor();
        static residentPkgKeys: string[];
        ...
        static buttonDisableSound: string;
        ...
        static packageConfig: {
            [packageName: string]: PackageLoadType;
        };
        static defaultTaskId: number;
        static textInputDelayInitSec: number;
        static defaultBundle: AssetManager.Bundle;
        static listSetDataCheckFlag: boolean;
        static listSetDataCheck(list: GList, doFinish: Function, doChildFinish: Function): void;
    }
    ...
    export function checkIsResidentPkg(pkgName: string): boolean;
    export function inerlistRenderHelper<T>(list: GList, datas: any[]): Promise<ArrayCollection<T>>;
}

declare module 'fairygui-cc/DragDropManager' {
    import { Constructor } from "cc";
    import { GObject } from "fairygui-cc/GObject";
    import { GComponent } from "fairygui-cc/FairyGUI";
    export class DragDropManager {
        static get inst(): DragDropManager;
        constructor();
        get dragAgent(): GObject;
        get dragAgentObj(): GObject;
        get dragging(): boolean;
        startDrag(icon: string, renderCtor?: Constructor<any>, sourceData?: any, touchId?: number, offsetGlobalX?: number, offsetGlobalY?: number, delayMis?: number): void;
        startDragObj(obj: GComponent, renderCtor?: Constructor<any>, sourceData?: any, touchId?: number, offsetGlobalX?: number, offsetGlobalY?: number, delayMis?: number): void;
        get offYSize(): number;
        set offYSize(v: number);
        cancel(): void;
    }
}
...
declare module 'fairygui-cc/gears/GearBase' {
    ...
    export class GearBase {
        ...
        setup(buffer: ByteBuffer): void;
        selfSetup(values: string): void;
        updateFromRelations(dx: number, dy: number): void;
        protected addStatus(pageId: string, buffer: ByteBuffer): void;
        protected init(): void;
        apply(isSetup?: boolean): void;
        updateState(): void;
    }
...
declare module 'fairygui-cc/display/Image' {
    ...
    export class Image extends Sprite {
        ...
        get fillAmount(): number;
        set fillAmount(value: number);
        setSpriteFrame(sprite: SpriteFrame): void;
    }
}
...
declare module 'fairygui-cc/utils/ArrayCollection' {
    import { EventTarget } from "cc";
    export enum ArrayCollectionEventKind {
        ...
        REPLACE = 5,
        ADD_MULT = 6,
        ADD_MULT_AND_SCROLL = 7
    }
    export class ArrayCollection<T> extends EventTarget {
        ...
        removeItem(item: T): T;
        removeItemAt(index: number, length?: number): T;
        removeAllItems(): void;
        replaceItemAt(item: T, index: number): T;
        replaceAll(newSource: T[]): void;
        addItems(items: T[], scrollBottom?: boolean): void;
    }
}

declare module 'fairygui-cc/event/MyEvent' {
    import { Event, Vec2 } from 'cc';
    import { GObject } from 'fairygui-cc/GObject';
    import { InputProcessor } from 'fairygui-cc/event/InputProcessor';
    export class MyEvent extends Event {
        ...
        static COLLECTION_CHANGED: string;
        ...
        static SELECT_ITEM: string;
        static CLICK_ITEM: string;
        static LOADED: string;
        static COMPLETE: string;
        static WINTWEENEND: string;
        initiator: GObject;
        pos: Vec2;
        touchId: number;
        clickCount: number;
    ...
    export function borrowEvent(type: string, bubbles?: boolean): MyEvent;
    export function returnEvent(evt: MyEvent): void;
}

declare module 'fairygui-cc/utils/JobSystem' {
    import { EventTarget } from "cc";
    export class JobSystem extends EventTarget {
            /** idle, welcome new jobs */
            static readonly kStatusIdle = 0;
            /** busy, working for some jobs */
            static readonly kStatusBusy = 1;
            /** closed, closed and would not receive job any more and is processing the remaining jobs now */
            static readonly kStatusClosed = 2;
            /** drained, ready to be destroy */
            static readonly kStatusDrained = 3;
            ...
            get status(): number;
            get curJob(): IJob;
            constructor(option?: JobCreateOption);
            addJob(fn: JobExecute, timeout?: number, onTimeout?: JobTimeoutHandle, jobKey?: string): number;
            addJob(job: IJob): number;
            /**
                * @deprecated
                */
            next(): void;
            terminate(jobId: number): void;
            terminateByKey(jobKey: string): void;
            getJobById<T extends IJob>(jobId: number): T;
            getJobByKey<T extends IJob>(jobKey: string): T;
    }
    export const jobSystem: JobSystem;
    /** 微型作业队列，用来加载图片等相对没那么耗时的操作，使得图片能够更快的展示出来 */
    export const microJobs: JobSystem;
    export interface IJob {
            timeout?: number;
            onExecute: JobExecute;
            onTimeout?: JobTimeoutHandle;
            jobKey?: string;
    }
    export type JobCreateOption = {
            intervalMs?: number | (() => number);
            slotDurationMs?: number | (() => number);
    };
    type JobExecute = (jobId: number) => Promise<any> | void;
    type JobTimeoutHandle = (jobId: number) => void;
    export {};
}

declare module 'fairygui-cc/utils/ListPageManager' {
    import { GList } from "fairygui-cc/GList";
    export enum ListPageMode {
        /** 垂直 */
        Vertical = 0,
        /** 水平 */
        Horizontal = 1
    ...
    export interface IListPageOption {
        /** 页面滚动方向，默认ListPageMode.Vertical */
        mode?: ListPageMode;
        /** 页尾控制,离列表尾部还有多大距离就要执行nextPage，一般设为item的高度或者宽度，默认100 */
        endThreshold?: number;
        /** 执行nextPage的间隔，默认为500 */
        intervalMs?: number;
        /** 总页数，默认为1 */
        totalPage?: number;
        /** 当前的最大页数，默认为0，因此默认状况下，首次调用nextPage时pageId自增为1 */
        curHeapPage?: number;
        /** 执行换页操作，填充数据 */
        nextPage(manager: ListPageManager): void;
    }
    export interface IListPageQuickConfigOption<T, U = T> extends Omit<IListPageOption, 'nextPage'> {
        /** 根据页id获取数据的回调 */
        getNextData(pageId: number): Promise<T[]> | T[];
        /** 每次获取新的分页数据之后用于更新最大页数 */
        getTotalPage?(): Promise<number> | number;
        /** 排序回调 */
        sorter?(a: U, b: U): number;
        /** 将原始数据转换为list data的回调 */
        convert?(raw: T): U;
    }
    export class ListPageManager {
        option: IListPageOption;
        /** 当前的最高页数 */
        heapPage: number;
        list: GList;
        /** 执行任务中，pending为true的时候不会触发nextPage*/
        pending: boolean;
        get curVersion(): number;
        constructor(list: GList);
        setOption(option: IListPageOption): void;
        quickConfig<T, U>(quickConfigOption: IListPageQuickConfigOption<T, U>): void;
        nextPage(): void;
    }
}

declare module 'fairygui-cc/UserData' {
    import { GComponent } from "fairygui-cc/GComponent";
    import { GObject } from "fairygui-cc/GObject";
    export interface IUserDataHandlers {
        [key: string]: (value: string, obj: GObject, data: any) => void;
    }
    export class UserData {
        static info: any;
        static handlers: IUserDataHandlers;
        static set(pkgId: string, pkgItemId: string, objId: string, data: any): void;
        static get(pkgId: string, pkgItemId: string, objId: string): any;
        static parseCustomData(baseUserData: string, customData: string): {};
        static setHandlers(handlers: IUserDataHandlers): void;
        static applyData(obj: GObject, data: any): void;
        static buildUserData(component: GComponent): void;
    }
}
...
declare module 'fairygui-cc/Relations' {
    ...
    export class Relations {
        ...
        getHasDef(relationType: number): boolean;
    }
}
...
declare module 'fairygui-cc/event/InputProcessor' {
    ...
    export class InputProcessor extends Component {
        _captureCallback: (evt: MyEvent) => void;
        constructor();
        onLoad(): void;
        onEnable(): void;
        onDisable(): void;
